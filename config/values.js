...
const values = {
  ...
  host: EnvVars.string('HOST', '192.168.1.23'),
  // The port on which the server should run.
  port: EnvVars.number('PORT', 1337),

  // The port on which the client bundle development server should run.
  clientDevServerPort: EnvVars.number('CLIENT_DEV_PORT', 8000),
  ...
  htmlPage: {
    titleTemplate: 'Mindinventory - %s',
    defaultTitle: 'Mindinventory',
    description:
      'Mindinventory react application.',
  },
