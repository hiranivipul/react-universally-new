...
import AsyncLazyLoad from "./AsyncLazyLoad";
import AsyncSlider from "./AsyncSlider/AsyncSlider";
      ...
      <div style={{ paddingTop: "2rem" }}>
        <div>
          ...
          <Switch>
            ...
            <Route path="/Lazy" component={AsyncLazyLoad}/>
            <Route path="/slider" component={AsyncSlider}/>
            ...
            <div className="row">
              <div className="col-md-12">
                <div className="copyright">
                  &copy; Copyright <strong>Mindinventory</strong>. All Rights Reserved
                </div>
                <div className="credits">
                  Themes by <a href="https://mindinventory.com/">Mindinventory</a>
                </div>
              </div>
            </div>
          </div>
